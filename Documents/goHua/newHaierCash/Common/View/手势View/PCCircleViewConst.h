 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(255.0,255.0,255.0,1)

/**
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(2,140,229,1)
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor rgba(2,140,229,1)
 ...
 */
#define CircleViewCenterY kScreenH * 0.5
 ...
 *  绘制解锁界面准备好时，提示文字
 */
#define gestureTextBeforeSet @"设置手势密码"
 ...
 *  确认图案，提示再次绘制
 */
#define gestureTextDrawAgain @"再次输入"
