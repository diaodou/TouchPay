...
- (UILabel *) titleLabel
{
    if (_titleLabel == nil) {
        ...
        [_titleLabel setFont:[UIFont appFontRegularOfSize:14.0]];
    }
    return _titleLabel;
}
////没有数据时输出
- (UILabel *) noDataLabel
{
    if (_noDataLabel == nil) {
        ...
        [_noDataLabel setFont:[UIFont appFontRegularOfSize:14.0f]];
    }
    return _noDataLabel;
}
...
//    创建按钮
    for (int i = 0; i < cityArray.count; i ++) {
        ...
        if (i < self.arrayCityButtons.count) {
            ...
            [button.titleLabel setFont:[UIFont appFontRegularOfSize:14.0f]];
