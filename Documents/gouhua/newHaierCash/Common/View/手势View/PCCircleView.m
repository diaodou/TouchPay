...
- (void)gestureEndByTypeLoginWithGesture:(NSString *)gesture length:(CGFloat)length
{
    ...
    NSNotification *noti = [NSNotification notificationWithName:@"ges" object:@{@"ges":gesture}];
    [[NSNotificationCenter defaultCenter] postNotification:noti];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(changeCircleInCircleSetWithState:) name:@"gestureError" object:nil];
//    NSString *password = [SecurityLocal retriveLocalGuestPwd];
